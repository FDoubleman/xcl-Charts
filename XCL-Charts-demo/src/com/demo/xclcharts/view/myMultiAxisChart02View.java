...
public class myMultiAxisChart02View extends DemoView {
	...
	public myMultiAxisChart02View(Context context) {
		super(context);
		mContext=context;
		initChart();
	}
	public myMultiAxisChart02View(Context context,AccountChartBean accountChartBean) {
		super(context);
		mContext=context;
	...
	public myMultiAxisChart02View(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext=context;
		initChart();
	}

	public myMultiAxisChart02View(Context context, AttributeSet attrs, int defStyle) {
	...
	public void initDate(){
		...
		OptionRateBean optionRateBeanA = new OptionRateBean("A","30");
		OptionRateBean optionRateBeanB = new OptionRateBean("B","40");
		OptionRateBean optionRateBeanC = new OptionRateBean("C","60");
